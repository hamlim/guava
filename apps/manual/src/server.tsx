// File run by vite-node
// uses the react-server import conditions
...
import { fromFile, getEntryChunk } from "./utils/vite-helpers.mjs";
...
let Vite =
  process.env.NODE_ENV !== "production"
    ? await import("./utils/vite-helpers.mjs")
    : null;
...
type NodeClient = typeof import("./client-server.tsx");

// in dev we use Vite to load our Node client. In prod we import the bundle
// directly.
let { renderToHtml } = Vite
  ? await Vite.runtime.executeUrl("./client-server.tsx")
  : ((await import(
